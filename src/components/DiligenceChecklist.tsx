            ...
            <div className="flex items-center bg-card hover:bg-muted/20 transition-colors">
              ...
              <div className="flex items-center gap-3 pr-4">
                ...
                {category === "Zoning & Entitlements" && (
                  <a
                    href={`/deals/${dealId}/site-zoning`}
                    onClick={(e) => e.stopPropagation()}
                    className="flex items-center gap-1 text-2xs px-2 py-1 rounded-md bg-primary/10 text-primary hover:bg-primary/20 transition-colors"
                    title="Full zoning analysis on Site & Zoning page"
                  >
