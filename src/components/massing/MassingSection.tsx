      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="border rounded-md bg-muted/10 p-3 text-sm space-y-1">
            ...
            <div className="flex justify-between"><span>Est. Parking Spaces</span><span className="font-semibold tabular-nums">{fn(summary.total_parking_spaces_est)}{summary.total_units > 0 ? <span className="text-muted-foreground text-xs"> ({(summary.total_parking_spaces_est / summary.total_units).toFixed(2)} spaces/unit)</span> : null}</span></div>
