...
export default function KanbanCard({ deal, onStar }: KanbanCardProps) {
  return (
    <Link href={`/deals/${deal.id}`} className="block">
      <div className="group rounded-lg border border-border/40 bg-card/80 hover:bg-card hover:border-border hover:shadow-lifted p-3 transition-all duration-200 cursor-pointer">
        {/* Header: name + star */}
