...
export async function POST(
  ...
  try {
    ...
    const audienceTone = audience === "lender"
      ...
      : "Your tone should be CONFIDENT, REALISTIC, PROFESSIONAL, and OPTIMISTIC — presenting a compelling investment opportunity. Be specific with numbers and grounded in facts.";
...
The analyst wants this refinement: "${refinementPrompt}"

Rewrite the section incorporating this feedback. Keep the same general structure but apply the requested changes. All percentages are already in percent form. Do not include the section title as a header.`;
    } else {
      prompt = `${audienceTone}
...
Write this section as polished, investor-ready content in markdown format. Expand each key point into clear, compelling prose. Use the deal context to add specific numbers, facts, and analysis. Keep it concise but thorough.
