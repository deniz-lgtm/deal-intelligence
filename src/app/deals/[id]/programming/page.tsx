    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end mt-3">
        <button
          onClick={() => saveAll()}
          disabled={saving}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white transition-colors"
        >
          {saving ? "Pushing…" : "Push to Underwriting"}
        </button>
      </div>
      </>
      )}
