...
// Route-scoped error boundary for /deals/[id]/underwriting.
// Mirrors the Programming page boundary so iPhone users can
// screenshot the actual crash (message + digest + first 20 stack
// lines) instead of staring at the generic "Application error"
// overlay Next.js shows by default.
...
export default function UnderwritingError({
  ...
  useEffect(() => {
    ...
    console.error("[underwriting-page] client-side crash", error);
  }, [error]);
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 space-y-4">
      <div className="flex items-center gap-2 text-red-400">
        ...
        <h2 className="text-lg font-semibold">Underwriting page crashed</h2>
      </div>
